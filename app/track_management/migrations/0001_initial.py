# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-08 23:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extensions', models.TextField(blank=True, null=True, verbose_name='Extensions.')),
                ('trackLine', django.contrib.gis.db.models.fields.LineStringField(blank=True, null=True, srid=4326)),
                ('gpx_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='track_management.mdlGPXFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extensions', models.TextField(blank=True, null=True, verbose_name='Extensions.')),
                ('trackLine', django.contrib.gis.db.models.fields.MultiLineStringField(blank=True, null=True, srid=4326)),
                ('gpx_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='track_management.mdlGPXFile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('extensions', models.TextField(blank=True, null=True, verbose_name='Extensions.')),
                ('segmentLine', django.contrib.gis.db.models.fields.LineStringField(blank=True, null=True, srid=4326)),
                ('gpx_track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='track_management.mdlGPXTrack')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vertical_speed', models.FloatField(blank=True, null=True, verbose_name='Vertical Speed in meters per second (m/s)')),
                ('energy', models.FloatField(blank=True, null=True, verbose_name='Energy in Calories')),
                ('gpx_track_segment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='track_management.mdlGPXTrackSegment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hash_code', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
